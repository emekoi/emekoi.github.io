...
\begin{document}
    ...
    % \item \textbf{B.S.}~\textit{Computer Science}, {Sep 2021--June 2025}
    % \item \textit{GPA}: 3.4
    % \end{itemize}
    ...
    \begin{school}{California Institute of Technology}{Pasadena, CA}{3.4}{Sep 2021--June 2025}
        ...
        % \item Decidability and Tractability (CS 21), Algorithms (CS 38), Interactive Theorem Proving (CS 128), Programming Languages (CS 131), Compilers (CS 164), Computer Graphics Lab (CS 171)
